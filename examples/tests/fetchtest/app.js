...
const dcbase = "/js/rnd/domicile/domicile1";
...
class SafeContentLoader extends HTMLBox {
  ...
  async load(source) {
    ...
    if (false) {
      ...
      // returning array for an auto fail (need it to return text)
      // this is an example of the mismatch I'll like to smooth over (understand better)
      //const api = new SafeFetch1({ base: this.base });
